      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-6 sm:mb-8">
            <div className="flex justify-center mb-6">
              <Animated3DIcon 
                ...
                bgGradient="linear-gradient(135deg, #10b981, #16a34a)"
              />
            </div>
            ...
            <p className="text-muted-foreground text-lg">
              Transform Excel spreadsheets and CSV files to PDF
            </p>
          </div>

          <Card className="mb-6 p-4 bg-emerald-50 dark:bg-emerald-950 border-emerald-200">
            <div className="flex items-start gap-3">
              <Download className="h-5 w-5 text-emerald-600 mt-0.5" />
              <div>
                <h3 className="font-semibold text-emerald-900 dark:text-emerald-100 mb-1">Excel/CSV to PDF Converter</h3>
                <p className="text-sm text-emerald-700 dark:text-emerald-300">
                  Upload Excel or CSV files and convert them to PDF format.
                </p>
              </div>
            </div>
          </Card>
          ...
          <div className="space-y-6">
            <FileUpload onFilesSelected={handleFilesSelected} multiple={false} accept=".xls,.xlsx,.csv" />
          ...
          <div className="mt-8 sm:mt-12 p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-muted/40 to-muted/20 rounded-xl sm:rounded-2xl border-2 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                ...
                How to Convert Excel/CSV to PDF
              </h2>
