        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="mb-6 p-4 bg-orange-50 dark:bg-orange-950 border-orange-200">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-orange-900 dark:text-orange-100 mb-1">PowerPoint to PDF Converter</h3>
                <p className="text-sm text-orange-700 dark:text-orange-300">
                  Upload a PowerPoint file and convert it to PDF format.
                </p>
              </div>
            </div>
          </Card>
          ...
          <div className="space-y-6">
            <FileUpload onFilesSelected={handleFilesSelected} multiple={false} accept=".ppt,.pptx" />
          ...
          <Card className="mt-8 p-4 sm:p-6 bg-gradient-to-br from-muted/50 to-muted/30 border-2 relative overflow-hidden group hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                {["📊 Convert PowerPoint to PDF", "🎯 Preserves slides and layout", "⚡ Fast Python backend", "🔒 Secure local processing", "💾 Supports .ppt and .pptx", "🖼️ Maintains images and graphics"].map((feature, index) => (
                  <div 
                    key={index} 
